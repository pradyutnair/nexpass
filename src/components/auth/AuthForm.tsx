  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      await account.createOAuth2Session(
        'google' as any, // Type assertion for Google OAuth
    ...
    <div className="glass-card p-8 w-full max-w-md mx-auto">
      ...
      <form onSubmit={handleEmailAuth} className="space-y-6">
        ...
        <Button
          type="submit"
          disabled={isLoading}
          className="w-full glass-button text-white font-medium py-3 glow-hover flex items-center justify-center gap-2"
        >
          {isLoading && (
